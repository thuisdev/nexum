  ...
  return (
    <AppSection className="!py-8 md:!py-12">
      <PageHeader
        ...
        action={
          <span className="inline-flex items-center rounded-full bg-amber-100 px-3 py-1 text-xs font-medium text-amber-700">
            {displayName(user ?? undefined, 'Arbiter')}
          </span>
        }
      />
      ...
      {loading ? (
        ...
        <EmptyPanel
          icon={Gavel}
          title="No disputes assigned"
          message="When clients and freelancers escalate a milestone, cases will appear here for review."
        />
      )}
    </AppSection>
  )
